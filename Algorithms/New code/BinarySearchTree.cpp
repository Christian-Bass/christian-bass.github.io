...
// Description : Binary search tree and linear search algorithm
//============================================================================
...
void linearSearch(string csvPath, string bidKey) {
    cout << "Loading CSV file " << csvPath << endl;
    ...
    try {
        ...
        for (unsigned int i = 0; i < file.rowCount(); i++) {
            ...
            //checking if most recent loaded bid matches the id we are searching for and displays bid
            if (bid.bidId == bidKey) {
                cout << "Item: " << bid.title << ", Fund: " << bid.fund << ", Amount: " << bid.amount << endl;
                break;
            }
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        cout << "  5. Find Bid with Linear search" << endl;
        cout << "  9. Exit" << endl;
        cout << "Enter choice: ";
        cin >> choice;
        ...
        case 2:
            if (loaded = false) { //checks if bids have been loaded to avoid issues
                cout << "load bids before using this function" << endl;
                exit(0);
            }
